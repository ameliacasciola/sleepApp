        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alarmTime.append(String.valueOf(dateCalendar.get(Calendar.YEAR)) + '-' + String.valueOf(dateCalendar.get(Calendar.MONTH) + 1) + '-' +
                        String.valueOf(dateCalendar.get(Calendar.DAY_OF_MONTH)) + ' ' + String.valueOf(timeCalendar.get(Calendar.HOUR_OF_DAY)) + ':' +
                        String.valueOf(timeCalendar.get(Calendar.MINUTE)));
